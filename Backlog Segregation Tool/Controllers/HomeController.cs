...
namespace Backlog_Segregation_Tool.Controllers
{
	public class HomeController : Controller
	{
		...
		public IActionResult Swarmed(String gname = "DCHA.3.Architect.AMS.Imp")
		{
			...
			tasks_fdata=BacklogSperator.FiltereUsingTag(tasks_fdata,"swarmed");
			BacklogSperator.filtered_data = tasks_fdata;
			BacklogSperator.getDiplomatsCases(Utility.diplometsClients, Utility.ColumnsOrder);
			BacklogSperator.getChallangersCases(Utility.ChallangersMaxDays, Utility.ChallangerTag, Utility.ColumnsOrder);
		...
		public IActionResult FastTrack(String gname = "DCHA.3.Architect.AMS.Imp")
		{
			...
			try
			{
				...
				tasks_fdata = BacklogSperator.MapTasksData(fdata, tasks_fdata);
				tasks_fdata = BacklogSperator.FiltereUsingTag(tasks_fdata, "fasttrack");
				BacklogSperator.filtered_data = tasks_fdata;
				BacklogSperator.getDiplomatsCases(Utility.diplometsClients, Utility.ColumnsOrder);
				BacklogSperator.getChallangersCases(Utility.ChallangersMaxDays, Utility.ChallangerTag, Utility.ColumnsOrder);
